...
<h4 class=" mb-4">
 <h2 class="card-subtitle mb-2 text-muted" style="text-align:center"> Listado de Libros {{$material->name}}es</h2> 
  <br> 
  </h4>
</div>
...
@else
<strong>No hay Libros Disponibles en esta Etiqueta</strong>

                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-8">
                          <div class="form-group  {{$errors->has('description') ? 'text-danger' : '' }} ">
                                ...
                                <textarea name="description" id="" cols="30" rows="10" class="form-control {{$errors->has('description') ? 'is-invalid' : '' }} ">{{old('description',$objective->description)}}</textarea>
